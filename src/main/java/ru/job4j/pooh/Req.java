...
public class Req {
    ...
    private static String splashSplitExtractor(String[] array, int pointer) {
    ...
    private static List<String> contentParser(String content) {
        ...
        if (GET.equals(rsl.get(0)) && TOPIC.equals(rsl.get(1))) {
            ...
            rsl.add(3, splashSplitExtractor(slashSplit, 3));
        } else if (POST.equals(rsl.get(0))) {
            rsl.add(2, splashSplitExtractor(slashSplit, 2));
